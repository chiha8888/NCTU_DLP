...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--data-list", type=str, default='/path/to/dataset/source_list', help="Path to the file listing the images in the source dataset.") #dataset/gta5_list/train.txt
        ...
        parser.add_argument("--num-steps-stop", type=int, default=120000, help="Number of training steps for early stopping.") #80000
        parser.add_argument("--power", type=float, default=0.9, help="Decay parameter to compute the learning rate (only for deeplab).")
        parser.add_argument("--init-weights", type=str, default=None, help="initial model.")  # DeepLab_init.pth
        ...
        parser.add_argument("--snapshot-dir", type=str, default='/path/to/snapshots/', help="Where to save snapshots of the model.") #snapshot/
